...
export const IPC = {
  ...
  LIST_CONNECTIONS: 'openpi:list-connections',
  CREATE_CONNECTION: 'openpi:create-connection',
  UPDATE_CONNECTION: 'openpi:update-connection',
  REMOVE_CONNECTION: 'openpi:remove-connection',
  TEST_CONNECTION: 'openpi:test-connection',
  CONNECT_CONNECTION: 'openpi:connect-connection',
  DISCONNECT_CONNECTION: 'openpi:disconnect-connection',
  LIST_REMOTE_DIRECTORIES: 'openpi:list-remote-directories',
  CHECK_REMOTE_RUNTIME: 'openpi:check-remote-runtime',
  INSTALL_REMOTE_RUNTIME: 'openpi:install-remote-runtime',
  ADD_REMOTE_PROJECT: 'openpi:add-remote-project',
  SET_REMOTE_PROJECT_MODE: 'openpi:set-remote-project-mode',
  REMOVE_REMOTE_PROJECT: 'openpi:remove-remote-project',
  SET_CONNECTION_PROVIDER_KEY: 'openpi:set-connection-provider-key',
  REMOVE_CONNECTION_PROVIDER_KEY: 'openpi:remove-connection-provider-key',
  ...
  GET_BOOT_SESSION: 'openpi:get-boot-session',
  ...
  RESOLVE_SUB_SESSION_PATH: 'openpi:resolve-sub-session-path',
  RESOLVE_MOST_RECENT_SUB_SESSION_PATH: 'openpi:resolve-most-recent-sub-session-path',
  READ_TASK_SESSION_HISTORY: 'openpi:read-task-session-history',
  ...
  COMPANION_LIST: 'openpi:companion-list',
  COMPANION_PIN: 'openpi:companion-pin',
  COMPANION_SHOW_SIEGE: 'openpi:companion-show-siege',
  COMPANION_PET_ACTIVATE: 'openpi:companion-pet-activate',
  COMPANION_PET_MENU: 'openpi:companion-pet-menu',
  COMPANION_PET_POINTER: 'openpi:companion-pet-pointer',
  COMPANION_EVIDENCE_OPEN: 'openpi:companion-evidence-open',
  COMPANION_PACK_LIST: 'openpi:companion-pack-list',
  COMPANION_PACK_IMPORT: 'openpi:companion-pack-import',
  COMPANION_PACK_REMOVE: 'openpi:companion-pack-remove',
  COMPANION_PACK_GET: 'openpi:companion-pack-get',
  COMPANION_PROFILE_UPDATE: 'openpi:companion-profile-update',
  COMPANION_PET_EXPANDED: 'openpi:companion-pet-expanded',
  ...
  CONNECTION_STATUS_CHANGED: 'openpi:connection-status-changed',
  ...
  COMPANION_CHANGED: 'openpi:companion-changed',
  COMPANION_OPEN: 'openpi:companion-open',
} as const
